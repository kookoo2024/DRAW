...
// tabler-icons: triangle（顶点朝上的等腰三角形）
export const TriangleShapeIcon = createIcon(
  <g strokeWidth="1.5">
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export const ReloadIcon = createIcon(
  <path
    d="M3.5 9.5A4.5 4.5 0 0 1 12 6.34m1.5-1.84v4h-4M16.5 9.5A4.5 4.5 0 0 1 8 13.66m-1.5 1.84v-4h4"
    strokeWidth="1.25"
  />,
  modifiedTablerIconProps,
);
